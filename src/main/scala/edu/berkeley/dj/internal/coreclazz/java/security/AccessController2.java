package edu.berkeley.dj.internal.coreclazz.java.security;
...
public final class AccessController2 {
     ...
     */
    @CallerSensitive
    public static <T> T doPrivilegedWithCombiner(DJPrivilegedAction<T> action) {
        return AccessController.doPrivilegedWithCombiner(new PrivilegedAction<T>() {
            @Override
            public T run() {
                return action.run();
            }
