package edu.berkeley.dj.internal.coreclazz.scala.concurrent.forkjoin;

/**
 * Created by matthewfl
 *
 * This is copied out of scala
 *
 * It appears that this is based off
 */
...
/*public*/ abstract class CountedCompleter00DJ<T> extends ForkJoinTask00DJ<T> {
    ...
    final CountedCompleter00DJ<?> completer;
     ...
     */
    protected CountedCompleter00DJ(CountedCompleter00DJ<?> completer,
     ...
     * and an initial pending count of zero.
     */
    protected CountedCompleter00DJ() {
        this.completer = null;
    }
     ...
     * be this task itself)
     */
    public void onCompletion(CountedCompleter00DJ<?> caller) {
    }
     ...
     * ForkJoinTask00DJ#isCompletedAbnormally}.  The return value of this
     ...
     */
    public boolean onExceptionalCompletion(Throwable ex, CountedCompleter00DJ<?> caller) {
        return true;
    }
     ...
     */
    public final CountedCompleter00DJ<?> getCompleter() {
        return completer;
    }
     ...
     */
    public final CountedCompleter00DJ<?> getRoot() {
        CountedCompleter00DJ<?> a = this, p;
    ...
    public final void tryComplete() {
        CountedCompleter00DJ<?> a = this, s = a;
        for (int c;;) {
            if ((c = a.pending) == 0) {
                a.onCompletion(s);
     ...
     */
    public final CountedCompleter00DJ<?> firstComplete() {
        for (int c;;) {
            if ((c = pending) == 0)
                return this;
     ...
     * ForkJoinTask00DJ#quietlyComplete} and returns {@code null}.  Or, if
     ...
     */
    public final CountedCompleter00DJ<?> nextComplete() {
        CountedCompleter00DJ<?> p;
        if ((p = completer) != null)
    ...
    public final void quietlyCompleteRoot() {
        for (CountedCompleter00DJ<?> a = this, p;;) {
...
/**
 * An {@link ExecutorService} for running {@link ForkJoinTask00DJ}s.
 ...
 *    <td> {@link #execute(ForkJoinTask00DJ)}</td>
 *    <td> {@link ForkJoinTask00DJ#fork}</td>
 *  </tr>
 *  <tr>
 *    <td> <b>Await and obtain result</td>
 *    <td> {@link #invoke(ForkJoinTask00DJ)}</td>
 *    <td> {@link ForkJoinTask00DJ#invoke}</td>
 *  </tr>
 *  <tr>
 *    <td> <b>Arrange exec and obtain Future</td>
 *    <td> {@link #submit(ForkJoinTask00DJ)}</td>
 *    <td> {@link ForkJoinTask00DJ#fork} (ForkJoinTasks <em>are</em> Futures)</td>
 *  </tr>
 * </table>
 *
...
//    }
    ...
    /**
     * Factory for creating new {@link ForkJoinWorkerThread00DJ}s.
    ...
    public static interface ForkJoinWorkerThreadFactory {
         ...
         */
        public ForkJoinWorkerThread00DJ newThread(ForkJoinPool00DJ pool);
    }
    ...
    static final class DefaultForkJoinWorkerThreadFactory
        ...
        public final ForkJoinWorkerThread00DJ newThread(ForkJoinPool00DJ pool) {
            return new ForkJoinWorkerThread00DJ(pool);
        }
    }
...
//    }
     ...
     */
//    static final class EmptyTask extends ForkJoinTask00DJ<Void> {
//        private static final long serialVersionUID = -7721805057305804111L;
//        EmptyTask() { status = ForkJoinTask00DJ.NORMAL; } // force done
...
//        ForkJoinTask00DJ<?>[] array;   // the elements (initially unallocated)
//        final ForkJoinPool00DJ pool;   // the containing pool (may be null)
//        final ForkJoinWorkerThread00DJ owner; // owning thread or null if shared
//        volatile Thread parker;    // == owner during call to park; else null
//        volatile ForkJoinTask00DJ<?> currentJoin;  // task being joined in awaitJoin
//        ForkJoinTask00DJ<?> currentSteal; // current non-local task being executed
//
//        volatile Object pad10, pad11, pad12, pad13, pad14, pad15, pad16, pad17;
//        volatile Object pad18, pad19, pad1a, pad1b, pad1c, pad1d;
//
//        WorkQueue(ForkJoinPool00DJ pool, ForkJoinWorkerThread00DJ owner, int mode,
//                  int seed) {
//            this.pool = pool;
//            this.owner = owner;
//            this.mode = mode;
...
//         */
//        final void push(ForkJoinTask00DJ<?> task) {
//            ForkJoinTask00DJ<?>[] a; ForkJoinPool00DJ p;
//            int s = top, m, n;
...
//         */
//        final ForkJoinTask00DJ<?>[] growArray() {
//            ForkJoinTask00DJ<?>[] oldA = array;
//            int size = oldA != null ? oldA.length << 1 : INITIAL_QUEUE_CAPACITY;
//            if (size > MAXIMUM_QUEUE_CAPACITY)
//                throw new RejectedExecutionException("Queue capacity exceeded");
//            int oldMask, t, b;
//            ForkJoinTask00DJ<?>[] a = array = new ForkJoinTask00DJ<?>[size];
...
//                    x = (ForkJoinTask00DJ<?>)U.getObjectVolatile(oldA, oldj);
//                    if (x != null &&
...
//         */
//        final ForkJoinTask00DJ<?> pop() {
//            ForkJoinTask00DJ<?>[] a; ForkJoinTask00DJ<?> t; int m;
//            if ((a = array) != null && (m = a.length - 1) >= 0) {
//                for (int s; (s = top - 1) - base >= 0;) {
//                    long j = ((m & s) << ASHIFT) + ABASE;
//                    if ((t = (ForkJoinTask00DJ<?>)U.getObject(a, j)) == null)
//                        break;
...
//         */
//        final ForkJoinTask00DJ<?> pollAt(int b) {
//            ForkJoinTask00DJ<?> t; ForkJoinTask00DJ<?>[] a;
//            if ((a = array) != null) {
//                int j = (((a.length - 1) & b) << ASHIFT) + ABASE;
//                if ((t = (ForkJoinTask00DJ<?>)U.getObjectVolatile(a, j)) != null &&
//                        base == b &&
...
//         */
//        final ForkJoinTask00DJ<?> poll() {
//            ForkJoinTask00DJ<?>[] a; int b; ForkJoinTask00DJ<?> t;
//            while ((b = base) - top < 0 && (a = array) != null) {
//                int j = (((a.length - 1) & b) << ASHIFT) + ABASE;
//                t = (ForkJoinTask00DJ<?>)U.getObjectVolatile(a, j);
//                if (t != null) {
//                    if (base == b &&
//                            U.compareAndSwapObject(a, j, t, null)) {
//                        base = b + 1;
...
//         */
//        final ForkJoinTask00DJ<?> nextLocalTask() {
...
//         */
//        final ForkJoinTask00DJ<?> peek() {
//            ForkJoinTask00DJ<?>[] a = array; int m;
//            if (a == null || (m = a.length - 1) < 0)
//                return null;
//            int i = mode == 0 ? top - 1 : base;
//            int j = ((i & m) << ASHIFT) + ABASE;
//            return (ForkJoinTask00DJ<?>)U.getObjectVolatile(a, j);
//        }
//
//        /**
...
//         */
//        final boolean tryUnpush(ForkJoinTask00DJ<?> t) {
//            ForkJoinTask00DJ<?>[] a; int s;
...
//            ForkJoinTask00DJ.cancelIgnoringExceptions(currentJoin);
//            ForkJoinTask00DJ.cancelIgnoringExceptions(currentSteal);
//            for (ForkJoinTask00DJ<?> t; (t = poll()) != null; )
//                ForkJoinTask00DJ.cancelIgnoringExceptions(t);
//        }
//
//        /**
...
//            ForkJoinTask00DJ<?>[] a; int m, s; long j; ForkJoinTask00DJ<?> t;
...
//         */
//        final boolean tryRemoveAndExec(ForkJoinTask00DJ<?> task) {
//            boolean stat = true, removed = false, empty = true;
//            ForkJoinTask00DJ<?>[] a; int m, s, b, n;
//            if ((a = array) != null && (m = a.length - 1) >= 0 &&
//                    (n = (s = top) - (b = base)) > 0) {
//                for (ForkJoinTask00DJ<?> t;;) {           // traverse from s to b
...
//         */
//        final boolean pollAndExecCC(ForkJoinTask00DJ<?> root) {
//            ForkJoinTask00DJ<?>[] a; int b; Object o;
//            outer: while ((b = base) - top < 0 && (a = array) != null) {
//                long j = (((a.length - 1) & b) << ASHIFT) + ABASE;
//                if ((o = U.getObject(a, j)) == null ||
//                        !(o instanceof CountedCompleter))
//                    break;
//                for (CountedCompleter00DJ<?> t = (CountedCompleter00DJ<?>)o, r = t;;) {
//                    if (r == root) {
//                        if (base == b &&
//                                U.compareAndSwapObject(a, j, t, null)) {
//                            base = b + 1;
...
//         * after execution.
//         */
//        final void runTask(ForkJoinTask00DJ<?> t) {
//            if (t != null) {
...
//         */
//        final void runSubtask(ForkJoinTask00DJ<?> t) {
//            if (t != null) {
//                ForkJoinTask00DJ<?> ps = currentSteal;
//                (currentSteal = t).doExec();
//                currentSteal = ps;
//            }
//        }
...
//                Class<?> ak = ForkJoinTask00DJ[].class;
...
//    private static final RuntimePermission modifyThreadPermission;
     ...
     */
//    static final ForkJoinPool00DJ common;
...
//                if ((t instanceof ForkJoinWorkerThread00DJ) &&
//                        (w = ((ForkJoinWorkerThread00DJ)t).workQueue) != null)
//                    r = w.seed;
...
//                Throwable ex = null;
//                ForkJoinWorkerThread00DJ wt = null;
//                try {
//                    if ((fac = factory) != null &&
...
//    }
     ...
     */
//    final WorkQueue registerWorker(ForkJoinWorkerThread00DJ wt) {
...
//    }
     ...
     */
//    final void deregisterWorker(ForkJoinWorkerThread00DJ wt, Throwable ex) {
//        WorkQueue w = null;
...
//            ForkJoinTask00DJ.helpExpungeStaleExceptions();
//        else                                // rethrow
//            ForkJoinTask00DJ.rethrow(ex);
//    }
...
//     */
//    private void fullExternalPush(ForkJoinTask00DJ<?> task) {
...
//    }
     ...
     */
//    private final ForkJoinTask00DJ<?> scan(WorkQueue w) {
//        WorkQueue[] ws; int m;
...
//            do {
//                WorkQueue q; ForkJoinTask00DJ<?>[] a; int b;
//                if ((q = ws[(r + j) & m]) != null && (b = q.base) - q.top < 0 &&
//                        (a = q.array) != null) {     // probably nonempty
//                    int i = (((a.length - 1) & b) << ASHIFT) + ABASE;
//                    ForkJoinTask00DJ<?> t = (ForkJoinTask00DJ<?>)
...
//    }
     ...
     */
//    private void helpSignal(ForkJoinTask00DJ<?> task, int origin) {
...
//    }
     ...
     */
//    private int tryHelpStealer(WorkQueue joiner, ForkJoinTask00DJ<?> task) {
//        int stat = 0, steps = 0;                    // bound to avoid cycles
//        if (joiner != null && task != null) {       // hoist null checks
//            restart: for (;;) {
//                ForkJoinTask00DJ<?> subtask = task;     // current target
...
//                        ForkJoinTask00DJ[] a;  int b;
//                        if (subtask.status < 0)     // surround probes with
//                            continue restart;       //   consistency checks
//                        if ((b = v.base) - v.top < 0 && (a = v.array) != null) {
//                            int i = (((a.length - 1) & b) << ASHIFT) + ABASE;
//                            ForkJoinTask00DJ<?> t =
//                                    (ForkJoinTask00DJ<?>)U.getObjectVolatile(a, i);
...
//                            ForkJoinTask00DJ<?> next = v.currentJoin;
//                            if (subtask.status < 0 || j.currentJoin != subtask ||
//                                    v.currentSteal != subtask)
//                                continue restart;   // stale
...
//    }
     ...
     */
//    private int helpComplete(ForkJoinTask00DJ<?> task, int mode) {
...
//    }
     ...
     */
//    final int awaitJoin(WorkQueue joiner, ForkJoinTask00DJ<?> task) {
//        int s = 0;
//        if (joiner != null && task != null && (s = task.status) >= 0) {
//            ForkJoinTask00DJ<?> prevJoin = joiner.currentJoin;
...
//                if ((s = task.status) >= 0 &&
//                        (task instanceof CountedCompleter00DJ))
...
//    }
     ...
     * @param task the task
     */
//    final void helpJoinOnce(WorkQueue joiner, ForkJoinTask00DJ<?> task) {
//        int s;
//        if (joiner != null && task != null && (s = task.status) >= 0) {
//            ForkJoinTask00DJ<?> prevJoin = joiner.currentJoin;
//            joiner.currentJoin = task;
...
//            long c; WorkQueue q; ForkJoinTask00DJ<?> t; int b;
...
//    }
     ...
     */
//    final ForkJoinTask00DJ<?> nextTaskFor(WorkQueue w) {
//        for (ForkJoinTask00DJ<?> t;;) {
//            WorkQueue q; int b;
...
//        Thread t; ForkJoinWorkerThread00DJ wt; ForkJoinPool00DJ pool; WorkQueue q;
//        if (((t = Thread.currentThread()) instanceof ForkJoinWorkerThread00DJ)) {
//            int p = (pool = (wt = (ForkJoinWorkerThread00DJ)t).pool).config & SMASK;
...
//        ForkJoinPool00DJ p; WorkQueue[] ws; int m; Submitter z;
...
//    }
     ...
     */
//    static boolean tryExternalUnpush(ForkJoinTask00DJ<?> t) {
//        ForkJoinPool00DJ p; WorkQueue[] ws; WorkQueue q; Submitter z;
//        ForkJoinTask00DJ<?>[] a;  int m, s;
//        if (t != null &&
...
//    }
     ...
     */
//    private void externalHelpComplete(WorkQueue q, ForkJoinTask00DJ<?> root) {
//        ForkJoinTask00DJ<?>[] a; int m;
...
//                    if ((o = U.getObject(a, j)) != null &&
//                            (o instanceof CountedCompleter)) {
//                        CountedCompleter00DJ<?> t = (CountedCompleter00DJ<?>)o, r = t;
//                        do {
//                            if (r == root) {
...
//    }
     ...
     */
//    static void externalHelpJoin(ForkJoinTask00DJ<?> t) {
//        // Some hard-to-avoid overlap with tryExternalUnpush
//        ForkJoinPool00DJ p; WorkQueue[] ws; WorkQueue q, w; Submitter z;
//        ForkJoinTask00DJ<?>[] a;  int m, s, n;
//        if (t != null &&
//                (z = submitters.get()) != null &&
//                (p = common) != null &&
//                (ws = p.workQueues) != null &&
...
//    }
     ...
     *         java.lang.RuntimePermission}{@code ("modifyThread")}
     */
    public ForkJoinPool00DJ(int parallelism) {
...
//        sb.append("-worker-");
     ...
     */
//    ForkJoinPool00DJ(int parallelism, long ctl,
//                     ForkJoinWorkerThreadFactory factory,
//                     Thread.UncaughtExceptionHandler handler) {
...
//    }
     ...
     * @since 1.8
     */
    public static ForkJoinPool00DJ commonPool() {
...
//        return common;
     ...
     *         scheduled for execution
     */
    public <T> ForkJoinTask00DJ<T> submit(Callable<T> task) {
        ForkJoinTask00DJ<T> job = new ForkJoinTask00DJ.AdaptedCallable<T>(task);
//        externalPush(job);
        throw new NotImplementedException();
//        return job;
    }
     ...
     *         scheduled for execution
     */
    public <T> ForkJoinTask00DJ<T> submit(Runnable task, T result) {
        ForkJoinTask00DJ<T> job = new ForkJoinTask00DJ.AdaptedRunnable<T>(task, result);
//        externalPush(job);
//        return job;
        throw new NotImplementedException();
    }
     ...
     *         scheduled for execution
     */
    public ForkJoinTask00DJ<?> submit(Runnable task) {
        if (task == null)
            throw new NullPointerException();
        ForkJoinTask00DJ<?> job;
        if (task instanceof ForkJoinTask00DJ<?>) // avoid re-wrap
    ...
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks) {
        ...
        try {
            for (Callable<T> t : tasks) {
                ForkJoinTask00DJ<T> f = new ForkJoinTask00DJ.AdaptedCallable<T>(t);
                futures.add(f);
//                externalPush(f);
                throw new NotImplementedException();
            }
            for (int i = 0, size = futures.size(); i < size; i++)
                ((ForkJoinTask00DJ<?>)futures.get(i)).quietlyJoin();
            done = true;
            return futures;
        } finally {
            if (!done)
...
//        return false;
     ...
     */
    protected ForkJoinTask00DJ<?> pollSubmission() {
//        WorkQueue[] ws; WorkQueue w; ForkJoinTask00DJ<?> t;
//        if ((ws = workQueues) != null) {
//            for (int i = 0; i < ws.length; i += 2) {
...
//        return null;
     ...
     */
    protected int drainTasksTo(Collection<? super ForkJoinTask00DJ<?>> c) {
//        int count = 0;
//        WorkQueue[] ws; WorkQueue w; ForkJoinTask00DJ<?> t;
//        if ((ws = workQueues) != null) {
//            for (int i = 0; i < ws.length; ++i) {
...
//                (short)(c >>> TC_SHIFT) == -(config & SMASK));
     ...
     * advisory notes for class {@link ForkJoinTask00DJ} stating that
...
//        return terminated;
     ...
     * in effect to {@link ForkJoinTask00DJ#helpQuiesce}. Otherwise,
...
//        long nanos = unit.toNanos(timeout);
//        ForkJoinWorkerThread00DJ wt;
//        Thread thread = Thread.currentThread();
//        if ((thread instanceof ForkJoinWorkerThread00DJ) &&
//                (wt = (ForkJoinWorkerThread00DJ)thread).pool == this) {
...
//            found = false;
//            for (int j = (m + 1) << 2; j >= 0; --j) {
//                ForkJoinTask00DJ<?> t; WorkQueue q; int b;
...
//    }
     ...
     * thread invoking {@link ForkJoinPool00DJ#managedBlock}.  The
     ...
     * is a {@link ForkJoinWorkerThread00DJ}, this method possibly
     * arranges for a spare thread to be activated if necessary to
     * ensure sufficient parallelism while the current thread is blocked.
     *
     * <p>If the caller is not a {@link ForkJoinTask00DJ}, this method is
...
//        if (t instanceof ForkJoinWorkerThread00DJ) {
//            ForkJoinPool00DJ p = ((ForkJoinWorkerThread00DJ)t).pool;
...
//        }
    ...
    protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
        return new ForkJoinTask00DJ.AdaptedRunnable<T>(runnable, value);
    }

    protected <T> RunnableFuture<T> newTaskFor(Callable<T> callable) {
        return new ForkJoinTask00DJ.AdaptedCallable<T>(callable);
    }
...
//        try {
//            U = getUnsafe();
//            Class<?> k = ForkJoinPool00DJ.class;
...
//
//        common = new ForkJoinPool00DJ(par, ct, fac, handler);
//    }
